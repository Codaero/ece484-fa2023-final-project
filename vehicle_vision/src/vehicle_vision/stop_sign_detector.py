...
class StopSignDetector():
    ...
    def __init__(self, name):
        ...
        self.pub_image = rospy.Publisher("stopSignDet/boundBox", Image, queue_size=1)
    ...
    def img_callback_real(self, data):
        ...
        self.plot_bboxes(cv_image, results[0].boxes.data)
    ...
    def plot_bboxes(self, image, boxes, labels=[], colors=[], score=True, conf=0.8):
        #Define COCO Labels
        if labels == []:
        ...
        imageBox = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
        out_img_msg = self.bridge.cv2_to_imgmsg(imageBox, 'bgr8')
